...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ev.add(new Event(100,100,"t'hour","Boumestir","whatever","24/12/2020"));
        billet.add(new Billet(100, 1, "user2", Billet.TypeBillet.SIMPLE));
        billet.add(new Billet(500, 1, "MOHSEN", Billet.TypeBillet.VIP));
