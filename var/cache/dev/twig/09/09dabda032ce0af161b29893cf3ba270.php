...
/* organisateur/newBackGeneral.html.twig */
class __TwigTemplate_1f38191b4e172ec5aff023649e2022cb extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "organisateur/newBackGeneral.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "organisateur/newBackGeneral.html.twig"));

        $this->parent = $this->loadTemplate("baseBack.html.twig", "organisateur/newBackGeneral.html.twig", 1);
      ...
      <div class=\"page-title-wrapper\">
        <div class=\"page-title-heading\">
          ...
          <div>
            ...
            <div class=\"page-title-subheading\">Remplissez les champs pour enregistrer un nouvel organisateur.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class=\"main-card mb-3 card\">
      <div class=\"card-body\">
        ...
        <div class=\"mb-3\">
          ";
        // line 54
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 54, $this->source); })()), "espace", [], "any", false, false, false, 54), 'label', ["label" => "Espace associé"]);
        yield "
          ";
        // line 55
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 55, $this->source); })()), "espace", [], "any", false, false, false, 55), 'widget', ["attr" => ["class" => "form-control"]]);
        yield "
          <div class=\"text-danger small mt-1\">";
        // line 56
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 56, $this->source); })()), "espace", [], "any", false, false, false, 56), 'errors');
        yield "</div>
        </div>
...
";
    ...
    {
        return "organisateur/newBackGeneral.html.twig";
    }
    ...
    {
        return array (  215 => 68,  207 => 63,  197 => 56,  193 => 55,  189 => 54,  182 => 50,  178 => 49,  174 => 48,  167 => 44,  163 => 43,  159 => 42,  152 => 38,  148 => 37,  144 => 36,  137 => 32,  133 => 31,  129 => 30,  123 => 27,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
    ...
    <div class=\"main-card mb-3 card\">
      <div class=\"card-body\">
        ...
        <div class=\"mb-3\">
          ...
          {{ form_widget(form.description_org, {'attr': {'class': 'form-control', 'rows': '3', 'required': true}}) }}
          <div class=\"text-danger small mt-1\">{{ form_errors(form.description_org) }}</div>
        </div>

        <div class=\"mb-3\">
          {{ form_label(form.telef) }}
          {{ form_widget(form.telef, {'attr': {'class': 'form-control', 'required': true, 'pattern': '[0-9]{8}'}}) }}
          <div class=\"text-danger small mt-1\">{{ form_errors(form.telef) }}</div>
        </div>

        <div class=\"mb-3\">
          {{ form_label(form.espace, 'Espace associé') }}
          {{ form_widget(form.espace, {'attr': {'class': 'form-control'}}) }}
          <div class=\"text-danger small mt-1\">{{ form_errors(form.espace) }}</div>
        </div>
