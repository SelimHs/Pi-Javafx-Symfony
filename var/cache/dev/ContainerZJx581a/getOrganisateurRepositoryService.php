 ...
 */
class getOrganisateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OrganisateurRepository' shared autowired service.
     *
     * @return \App\Repository\OrganisateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OrganisateurRepository.php';

        return $container->privates['App\\Repository\\OrganisateurRepository'] = new \App\Repository\OrganisateurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
