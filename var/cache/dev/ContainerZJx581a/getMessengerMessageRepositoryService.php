 ...
 */
class getMessengerMessageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessengerMessageRepository' shared autowired service.
     *
     * @return \App\Repository\MessengerMessageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessengerMessageRepository.php';

        return $container->privates['App\\Repository\\MessengerMessageRepository'] = new \App\Repository\MessengerMessageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
