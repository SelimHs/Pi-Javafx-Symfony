 ...
 */
class getRemiseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RemiseRepository' shared autowired service.
     *
     * @return \App\Repository\RemiseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RemiseRepository.php';

        return $container->privates['App\\Repository\\RemiseRepository'] = new \App\Repository\RemiseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
